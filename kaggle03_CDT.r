...
# Se hicieron otros intentos con OB+ semillerío, pero con este script se obtuvo mejores resultados. 
# En intentos anteriores no reemplacé los datos de meses catástrofe con NA y utilicé menos meses de entrenamiento, aunque sí usé lags y delta lags (los mismos y más).  
...
PARAM  <- list()
PARAM$experimento  <- "plenaria-CDT"
...
PARAM$trainingstrategy$semilla <- 162677  # segunda semilla
...
PARAM$trainingstrategy$finaltrain <- c( 201901, 201902, 201903, 201904, 201905,
  ...
  202002, 202101, 202102, 202103, 202104,202105, 202106)
